...
![anchor](Images/07_MultiNode/GR_position_anchor.png)
...
![ref_point](Images/07_MultiNode/GR_position_refpoint.png)
...
![float_to_complex](Images/07_MultiNode/GR_position_float_to_complex.png)
...
![constellation_sink](Images/07_MultiNode/GR_position_constellationsink.png)
...
![constellation_graph](Images/07_MultiNode/GR_position_constellationgraph.png)
...
![constellation_with_hier](Images/07_MultiNode/GR_position_constellationwithhier.png)
...
![point_coordinate_hier](Images/07_MultiNode/GR_position_point_coordinate_hier.png)
...
![distanceformula](Images/07_MultiNode/GR_position_distanceformular.png)
...
![data_steam_flowgraph](Images/07_MultiNode/GR_position_distance_stream_flowgraph.png)
...
![constantx](Images/07_MultiNode/GR_position_constant_source_x.png)

![constanty](Images/07_MultiNode/GR_position_constant_source_y.png)
...
![complex_to_mag](Images/07_MultiNode/GR_position_complex_to_mag.png)
...
![sqrt](Images/07_MultiNode/GR_position_transcendental_sqrt.png)

![sqrt_prop](Images/07_MultiNode/GR_position_transcendental_prop.png)
...
![distance_steam](Images/07_MultiNode/GR_position_distance_stream.png)
...
![devide_dsq_stream](Images/07_MultiNode/GR_position_devide_dsq_stream.png)

After tidying up the flowgraph, it should look like this

![data_stream_flowgraph_with_hier](Images/07_MultiNode/GR_position_distance_stream_flowgraph_with_hier.png)
...
![distancesq](Images/07_MultiNode/GR_position_distancesq_stream.png)

With all the flowgraphs component set up, put all of them into a QT GUI sink with noise to observe the the peaks

![QTGUI](Images/07_MultiNode/GR_position_qtguisink_stream.png)
...
![peakobservation](Images/07_MultiNode/GR_position_peak_stream.png)

### Variable block method

![variable_flowgraph](Images/07_MultiNode/GR_position_distance_variable_flowgraph_with_hier.png)
...
![import_good](Images/07_MultiNode/GR_position_import_good.png)
...
![import_no](Images/07_MultiNode/GR_position_import_no_good.png)

![import_prop](Images/07_MultiNode/GR_position_import_prop.png)
...
Calulating distance
![distance_var](Images/07_MultiNode/GR_position_distance_variable_block.png)

![distance_prop](Images/07_MultiNode/GR_position_distance_variable_prop.png)

Calculating distance square

![distancesq_var](Images/07_MultiNode/GR_position_distancesq_variable_block.png)

![distancesq_prop](Images/07_MultiNode/GR_position_distancesq_variable_prop.png)
...
![multiply_const_variable](Images/07_MultiNode/GR_position_multiply_const_variable.png)

Here is the calculation for Multiply const block

![multiply_const_prop](Images/07_MultiNode/GR_position_multiply_const_variable_prop.png)

The frequency display by using this method is like what we saw in the data streaming method.

![peak_variable](Images/07_MultiNode/GR_position_peak_variable.png)
...
![FSPL_flowgraph](Images/07_MultiNode/GR_position_FSPL_flowgraph.png)
...
![FSPLformular](Images/07_MultiNode/GR_position_FSPLformular.png)
...
![FSPLmanipulate](Images/07_MultiNode/GR_position_FSPLmanipulate.png)
...
![pi](Images/07_MultiNode/GR_position_pi.png)

For speed of light, create another variable block and define its value. 

![lightspeed](Images/07_MultiNode/GR_position_light_speed.png)
...
![GP](Images/07_MultiNode/GR_position_GP.png)

![GP_prop](Images/07_MultiNode/GR_position_GP_prop.png)

Next, in another variable block, convert the power gain into dB.

![GP_dB](Images/07_MultiNode/GR_position_GP_dB.png)

![GP_dB_prop](Images/07_MultiNode/GR_position_GP_dB_prop.png)

Finally, in another variable block, calculate the voltage gain.

![GV](Images/07_MultiNode/GR_position_GV.png)

![GV_prop](Images/07_MultiNode/GR_position_GV_prop.png)
...
![FSPL_hier](Images/07_MultiNode/GR_position_FSPL_hier.png)
...
![FSPL_peak](Images/07_MultiNode/GR_position_FSPL_peak.png)
