...
class GNURadio_Overview(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GR Tutorial: Overview", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GR Tutorial: Overview")
        ...
        self.settings = Qt.QSettings("GNU Radio", "GNURadio_Overview")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "Real Sinusoid, Complex Representation", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.top_grid_layout.addWidget(self._qtgui_sink_x_0_win, 0, 0, 2, 1)
        for r in range(0, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            "Real Sinusoid - Frequency Domain", #name
            1,
            None # parent
        )
        ...
        self.connect((self.blocks_throttle_0_0_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_throttle_0_0_0, 0), (self.qtgui_time_sink_x_1, 0))
...
def main(top_block_cls=GNURadio_Overview, options=None):
