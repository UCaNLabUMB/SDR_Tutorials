...
class Packet_test_file_in(gr.top_block):

    def __init__(self, P_noise=0.0035, fn='filename', multiply_constant_=0.08):
        gr.top_block.__init__(self, "Packet_test_file_in", catch_exceptions=True)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/christopher/Desktop/U-K_Auto_Data/Data Folder/rx_file', False)
...
def argument_parser():
    ...
    parser.add_argument(
        "--fn", dest="fn", type=str, default='filename',
...
def main(top_block_cls=Packet_test_file_in, options=None):
    if options is None:
